            ...
            <div class="row">
                <div class="contact">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <ul>
                            <li>
                                <i class="fa fa-address-book" aria-hidden="true"></i> KP2, Phường Sông Trí, TX Kỳ Anh, Hà Tĩnh                            </li>

                            <li>
                                <i class="fa fa-phone" aria-hidden="true"></i> Điện thoại: 0799.098.098                            </li>

                            <li>
                                <i class="fa fa-envelope" aria-hidden="true"></i> Email: pgh@bdskyanh.com                            </li>

                            <li>
                                <i class="fa fa-globe" aria-hidden="true"></i> Website: bdskyanh.com
                            </li>
                        </ul>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="contact-form">
                            <h4 class="text-center"><i>Quý khách vui lòng nhập đầy đủ thông tin.</i></h4>
                            <form class="form-horizontal contact-form" method="POST" action="/lien-he.html" role="form">
                                <div class="form-group">
                                    <label for="fullname" class="col-sm-3 control-label">Họ tên</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" value="" class="form-control" id="fullname" placeholder="Nhập Họ tên">
                                        <div class="error"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="tel" class="form-control" name="phone" value="" id="phone" placeholder="Nhập Số điện thoại">
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="title" value="" id="title" placeholder="Nhập Tiêu đề">
                                        <div class="error"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" id="content" name="content" placeholder="Nhập Nội dung"></textarea>
                                    </div>
                                </div>
